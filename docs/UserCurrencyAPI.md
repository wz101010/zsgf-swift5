...
# **userCurrencies**
```swift
    open class func userCurrencies(appKey: String, id: String, userId: String? = nil, completion: @escaping (_ data: UserCurrencyListApiResponse?, _ error: Error?) -> Void)
```
...
// 获取用户资产
UserCurrencyAPI.userCurrencies(appKey: appKey, id: id, userId: userId) { (response, error) in
...
# **userCurrencyConsume**
```swift
    open class func userCurrencyConsume(nonce: String, timestamp: Int64, signature: String, appKey: String, userId: String? = nil, currencyConsumeRequest: CurrencyConsumeRequest? = nil, completion: @escaping (_ data: BooleanApiResponse?, _ error: Error?) -> Void)
```
...
// 消费虚拟币
UserCurrencyAPI.userCurrencyConsume(nonce: nonce, timestamp: timestamp, signature: signature, appKey: appKey, userId: userId, currencyConsumeRequest: currencyConsumeRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func userCurrencyExchange(nonce: String, timestamp: Int64, signature: String, appKey: String, userId: String? = nil, exchangeCurrencyRequest: ExchangeCurrencyRequest? = nil, completion: @escaping (_ data: BooleanApiResponse?, _ error: Error?) -> Void)
```
...
// 兑换虚拟币
UserCurrencyAPI.userCurrencyExchange(nonce: nonce, timestamp: timestamp, signature: signature, appKey: appKey, userId: userId, exchangeCurrencyRequest: exchangeCurrencyRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func userCurrencyRecharge(nonce: String, timestamp: Int64, signature: String, appKey: String, userId: String? = nil, rechargePointRequest: RechargePointRequest? = nil, completion: @escaping (_ data: BooleanApiResponse?, _ error: Error?) -> Void)
```
...
// 充值虚拟币
UserCurrencyAPI.userCurrencyRecharge(nonce: nonce, timestamp: timestamp, signature: signature, appKey: appKey, userId: userId, rechargePointRequest: rechargePointRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func userCurrencyTransactions(appKey: String, transType: String? = nil, curCode: String? = nil, startTime: Date? = nil, endTime: Date? = nil, skip: Int? = nil, take: Int? = nil, userId: String? = nil, completion: @escaping (_ data: UserCurrencyCurrencyTransResultApiResponse?, _ error: Error?) -> Void)
```
...
// 虚拟币交易记录
UserCurrencyAPI.userCurrencyTransactions(appKey: appKey, transType: transType, curCode: curCode, startTime: startTime, endTime: endTime, skip: skip, take: take, userId: userId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
