...
# **userFollowers**
```swift
    open class func userFollowers(appKey: String, tag: String? = nil, status: String? = nil, skip: Int? = nil, take: Int? = nil, completion: @escaping (_ data: UserFollowersResultApiResponse?, _ error: Error?) -> Void)
```
...
// 获取我的粉丝列表
UserAPI.userFollowers(appKey: appKey, tag: tag, status: status, skip: skip, take: take) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **userFollowing**
```swift
    open class func userFollowing(appKey: String, tag: String? = nil, status: String? = nil, skip: Int? = nil, take: Int? = nil, completion: @escaping (_ data: UserFollowingResultApiResponse?, _ error: Error?) -> Void)
```
...
// 获取我的关注列表
UserAPI.userFollowing(appKey: appKey, tag: tag, status: status, skip: skip, take: take) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **userFriendsNearBy**
```swift
    open class func userFriendsNearBy(x: Double, y: Double, distance: Int64, appKey: String, gender: String? = nil, ageS: Int? = nil, ageE: Int? = nil, tag: String? = nil, type: String? = nil, skip: Int? = nil, take: Int? = nil, completion: @escaping (_ data: UserFriendsNearByResultApiResponse?, _ error: Error?) -> Void)
```
...
let x = 987 // Double | 纬度
let y = 987 // Double | 经度
let distance = 987 // Int64 | 附近距离，单位：米
let appKey = "appKey_example" // String | 
let gender = "gender_example" // String | 性别 (optional)
let ageS = 987 // Int | 年龄段起始 (optional)
let ageE = 987 // Int | 年龄段结束 (optional)
let tag = "tag_example" // String | 兴趣标签 (optional)
...
// 附近的用户推荐
UserAPI.userFriendsNearBy(x: x, y: y, distance: distance, appKey: appKey, gender: gender, ageS: ageS, ageE: ageE, tag: tag, type: type, skip: skip, take: take) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
let appKey = "appKey_example" // String | 
let geoLocationModel = GeoLocationModel(latitude: 123, longitude: 123, locationName: "locationName_example", locationType: "locationType_example", recipientName: "recipientName_example", phoneNumber: "phoneNumber_example", email: "email_example", country: "country_example", state: "state_example", city: "city_example", district: "district_example", street: "street_example", zipCode: "zipCode_example", address: "address_example", mapType: "mapType_example", remark: "remark_example", tags: "tags_example", enable: false, showIndex: 123, createDate: Date(), lastUpdate: Date()) // GeoLocationModel | 位置信息 (optional)
...
let appKey = "appKey_example" // String | 
let appUserResetPwdRequest = AppUserResetPwdRequest(phone: "phone_example", email: "email_example", code: "code_example", pwd: "pwd_example") // AppUserResetPwdRequest | 重置密码的请求参数 (optional)
