...
open class UserFriendsAPI {
    ...
    /**
     ...
     - parameter userId: (query)  (optional, default to "")
    ...
    open class func userCommonInterests(appKey: String, tag: String? = nil, skip: Int? = nil, take: Int? = nil, userId: String? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: UserCommonInterestsResultApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return userCommonInterestsWithRequestBuilder(appKey: appKey, tag: tag, skip: skip, take: take, userId: userId).execute(apiResponseQueue) { result in
            switch result {
     ...
     */
    open class func userCommonInterestsWithRequestBuilder(appKey: String, tag: String? = nil, skip: Int? = nil, take: Int? = nil, userId: String? = nil) -> RequestBuilder<UserCommonInterestsResultApiResponse> {
    ...
    open class func userFollowUser(userId: Int64, appKey: String, fromUserId: String? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: BooleanApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return userFollowUserWithRequestBuilder(userId: userId, appKey: appKey, fromUserId: fromUserId).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    open class func userFollowUserWithRequestBuilder(userId: Int64, appKey: String, fromUserId: String? = nil) -> RequestBuilder<BooleanApiResponse> {
        ...
        var localVariableUrlComponents = URLComponents(string: localVariableURLString)
        localVariableUrlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            "fromUserId": (wrappedValue: fromUserId?.encodeToJSON(), isExplode: true),
        ])
    ...
    open class func userFollowers(appKey: String, tag: String? = nil, status: String? = nil, targetUserId: Int64? = nil, skip: Int? = nil, take: Int? = nil, userId: String? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: UserFollowersResultApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return userFollowersWithRequestBuilder(appKey: appKey, tag: tag, status: status, targetUserId: targetUserId, skip: skip, take: take, userId: userId).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    open class func userFollowersWithRequestBuilder(appKey: String, tag: String? = nil, status: String? = nil, targetUserId: Int64? = nil, skip: Int? = nil, take: Int? = nil, userId: String? = nil) -> RequestBuilder<UserFollowersResultApiResponse> {
    ...
    open class func userFollowing(appKey: String, tag: String? = nil, status: String? = nil, targetUserId: Int64? = nil, skip: Int? = nil, take: Int? = nil, checkUserId: Int64? = nil, onlyIDs: Bool? = nil, userId: String? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: BooleanApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return userFollowingWithRequestBuilder(appKey: appKey, tag: tag, status: status, targetUserId: targetUserId, skip: skip, take: take, checkUserId: checkUserId, onlyIDs: onlyIDs, userId: userId).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<BooleanApiResponse> 
     */
    open class func userFollowingWithRequestBuilder(appKey: String, tag: String? = nil, status: String? = nil, targetUserId: Int64? = nil, skip: Int? = nil, take: Int? = nil, checkUserId: Int64? = nil, onlyIDs: Bool? = nil, userId: String? = nil) -> RequestBuilder<BooleanApiResponse> {
    ...
    open class func userFriendsNearBy(longitude: Double, latitude: Double, appKey: String, country: String? = nil, state: String? = nil, city: String? = nil, district: String? = nil, gender: String? = nil, ageS: Int? = nil, ageE: Int? = nil, tag: String? = nil, distance: Int64? = nil, skip: Int? = nil, take: Int? = nil, userId: String? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: UserFriendsNearByResultApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return userFriendsNearByWithRequestBuilder(longitude: longitude, latitude: latitude, appKey: appKey, country: country, state: state, city: city, district: district, gender: gender, ageS: ageS, ageE: ageE, tag: tag, distance: distance, skip: skip, take: take, userId: userId).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    open class func userFriendsNearByWithRequestBuilder(longitude: Double, latitude: Double, appKey: String, country: String? = nil, state: String? = nil, city: String? = nil, district: String? = nil, gender: String? = nil, ageS: Int? = nil, ageE: Int? = nil, tag: String? = nil, distance: Int64? = nil, skip: Int? = nil, take: Int? = nil, userId: String? = nil) -> RequestBuilder<UserFriendsNearByResultApiResponse> {
    ...
    open class func userMutualFollowers(appKey: String, skip: Int? = nil, take: Int? = nil, userId: String? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: UserMutualFollowersResultApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return userMutualFollowersWithRequestBuilder(appKey: appKey, skip: skip, take: take, userId: userId).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    open class func userMutualFollowersWithRequestBuilder(appKey: String, skip: Int? = nil, take: Int? = nil, userId: String? = nil) -> RequestBuilder<UserMutualFollowersResultApiResponse> {
    ...
    open class func userMutualFollowings(appKey: String, skip: Int? = nil, take: Int? = nil, userId: String? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: UserMutualFollowingsResultApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return userMutualFollowingsWithRequestBuilder(appKey: appKey, skip: skip, take: take, userId: userId).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    open class func userMutualFollowingsWithRequestBuilder(appKey: String, skip: Int? = nil, take: Int? = nil, userId: String? = nil) -> RequestBuilder<UserMutualFollowingsResultApiResponse> {
    ...
    open class func userUnfollowUser(userId: Int64, appKey: String, fromUserId: String? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: BooleanApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return userUnfollowUserWithRequestBuilder(userId: userId, appKey: appKey, fromUserId: fromUserId).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<BooleanApiResponse> 
     */
    open class func userUnfollowUserWithRequestBuilder(userId: Int64, appKey: String, fromUserId: String? = nil) -> RequestBuilder<BooleanApiResponse> {
        var localVariablePath = "/UserFriends/{appKey}/Follower/{userId}"
        let userIdPreEscape = "\(APIHelper.mapValueToPathItem(userId))"
        let userIdPostEscape = userIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{userId}", with: userIdPostEscape, options: .literal, range: nil)
