...
open class UserLocationAPI {
    ...
    open class func userLocation(id: Int64, appKey: String, userId: String? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: GeoLocationModelApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return userLocationWithRequestBuilder(id: id, appKey: appKey, userId: userId).execute(apiResponseQueue) { result in
            switch result {
     ...
     */
    open class func userLocationWithRequestBuilder(id: Int64, appKey: String, userId: String? = nil) -> RequestBuilder<GeoLocationModelApiResponse> {
    ...
    open class func userLocationDelete(id: Int64, appKey: String, userId: String? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: BooleanApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return userLocationDeleteWithRequestBuilder(id: id, appKey: appKey, userId: userId).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    open class func userLocationDeleteWithRequestBuilder(id: Int64, appKey: String, userId: String? = nil) -> RequestBuilder<BooleanApiResponse> {
        var localVariablePath = "/UserLocation/{appKey}/{id}"
        let idPreEscape = "\(APIHelper.mapValueToPathItem(id))"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
    ...
    open class func userLocationPost(appKey: String, userId: String? = nil, geoLocationModel: GeoLocationModel? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: UserLocationPostResultApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return userLocationPostWithRequestBuilder(appKey: appKey, userId: userId, geoLocationModel: geoLocationModel).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    open class func userLocationPostWithRequestBuilder(appKey: String, userId: String? = nil, geoLocationModel: GeoLocationModel? = nil) -> RequestBuilder<UserLocationPostResultApiResponse> {
    ...
    open class func userLocationPut(id: Int64, appKey: String, userId: String? = nil, geoLocationModel: GeoLocationModel? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: BooleanApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return userLocationPutWithRequestBuilder(id: id, appKey: appKey, userId: userId, geoLocationModel: geoLocationModel).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<BooleanApiResponse> 
     */
    open class func userLocationPutWithRequestBuilder(id: Int64, appKey: String, userId: String? = nil, geoLocationModel: GeoLocationModel? = nil) -> RequestBuilder<BooleanApiResponse> {
        var localVariablePath = "/UserLocation/{appKey}/{id}"
        let idPreEscape = "\(APIHelper.mapValueToPathItem(id))"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
    ...
    open class func userLocations(appKey: String, tag: String? = nil, type: String? = nil, x: Double? = nil, y: Double? = nil, sphere: Int64? = nil, skip: Int? = nil, take: Int? = nil, userId: String? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: UserLocationsResultApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return userLocationsWithRequestBuilder(appKey: appKey, tag: tag, type: type, x: x, y: y, sphere: sphere, skip: skip, take: take, userId: userId).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    open class func userLocationsWithRequestBuilder(appKey: String, tag: String? = nil, type: String? = nil, x: Double? = nil, y: Double? = nil, sphere: Int64? = nil, skip: Int? = nil, take: Int? = nil, userId: String? = nil) -> RequestBuilder<UserLocationsResultApiResponse> {
        var localVariablePath = "/UserLocation/{appKey}"
        let appKeyPreEscape = "\(APIHelper.mapValueToPathItem(appKey))"
        let appKeyPostEscape = appKeyPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{appKey}", with: appKeyPostEscape, options: .literal, range: nil)
