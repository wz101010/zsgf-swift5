...
open class ExternalAccountAPI {
    ...
    open class func externalAccountSignIn(appKey: String, userId: String? = nil, externalAccountSignInRequest: ExternalAccountSignInRequest? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: TokenModelApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return externalAccountSignInWithRequestBuilder(appKey: appKey, userId: userId, externalAccountSignInRequest: externalAccountSignInRequest).execute(apiResponseQueue) { result in
            switch result {
     ...
     */
    open class func externalAccountSignInWithRequestBuilder(appKey: String, userId: String? = nil, externalAccountSignInRequest: ExternalAccountSignInRequest? = nil) -> RequestBuilder<TokenModelApiResponse> {
    ...
    open class func userExternalAccountBind(appKey: String, userId: String? = nil, externalAccountBindRequest: ExternalAccountBindRequest? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: BooleanApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return userExternalAccountBindWithRequestBuilder(appKey: appKey, userId: userId, externalAccountBindRequest: externalAccountBindRequest).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    open class func userExternalAccountBindWithRequestBuilder(appKey: String, userId: String? = nil, externalAccountBindRequest: ExternalAccountBindRequest? = nil) -> RequestBuilder<BooleanApiResponse> {
    ...
    open class func userOAuthAccounts(appKey: String, userId: String? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: UserLoginsListApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return userOAuthAccountsWithRequestBuilder(appKey: appKey, userId: userId).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    open class func userOAuthAccountsWithRequestBuilder(appKey: String, userId: String? = nil) -> RequestBuilder<UserLoginsListApiResponse> {
        var localVariablePath = "/ExternalAccount/{appKey}"
        let appKeyPreEscape = "\(APIHelper.mapValueToPathItem(appKey))"
        let appKeyPostEscape = appKeyPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{appKey}", with: appKeyPostEscape, options: .literal, range: nil)
    ...
    open class func userOAuthAccountsPutBind(id: Int64, appKey: String, userId: String? = nil, externalAccountPutRequest: ExternalAccountPutRequest? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: BooleanApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return userOAuthAccountsPutBindWithRequestBuilder(id: id, appKey: appKey, userId: userId, externalAccountPutRequest: externalAccountPutRequest).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<BooleanApiResponse> 
     */
    open class func userOAuthAccountsPutBindWithRequestBuilder(id: Int64, appKey: String, userId: String? = nil, externalAccountPutRequest: ExternalAccountPutRequest? = nil) -> RequestBuilder<BooleanApiResponse> {
    ...
    open class func userOAuthAccountsUnBind(id: Int64, appKey: String, userId: String? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: BooleanApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return userOAuthAccountsUnBindWithRequestBuilder(id: id, appKey: appKey, userId: userId).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<BooleanApiResponse> 
     */
    open class func userOAuthAccountsUnBindWithRequestBuilder(id: Int64, appKey: String, userId: String? = nil) -> RequestBuilder<BooleanApiResponse> {
        var localVariablePath = "/ExternalAccount/{appKey}/{id}"
        let idPreEscape = "\(APIHelper.mapValueToPathItem(id))"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
