...
open class StorageAPI {
    ...
    /**
     ...
     - parameter table: (path) 表名称 
     - parameter filter: (query) 查询条件 
     - parameter appKey: (path)  
     - parameter requestBody: (body) 更新的字段 
     - parameter replace: (query) 是否为全量替换，默认为 false (optional, default to false)
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    @discardableResult
    open class func storageBatchUpdate(table: String, filter: String, appKey: String, requestBody: [AnyCodable], replace: Bool? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: BooleanApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return storageBatchUpdateWithRequestBuilder(table: table, filter: filter, appKey: appKey, requestBody: requestBody, replace: replace).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     批量更新指定条件的数据
     - PUT /Storage/{appKey}/{table}/batch-update
     ...
     */
    open class func storageBatchUpdateWithRequestBuilder(table: String, filter: String, appKey: String, requestBody: [AnyCodable], replace: Bool? = nil) -> RequestBuilder<BooleanApiResponse> {
        var localVariablePath = "/Storage/{appKey}/{table}/batch-update"
        let tablePreEscape = "\(APIHelper.mapValueToPathItem(table))"
        let tablePostEscape = tablePreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{table}", with: tablePostEscape, options: .literal, range: nil)
        let appKeyPreEscape = "\(APIHelper.mapValueToPathItem(appKey))"
    ...
    /**
     ...
     - parameter table: (path) 表名称 
     - parameter appKey: (path)  
     - parameter filter: (query) 筛选条件，json格式 (optional)
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    @discardableResult
    open class func storageClear(table: String, appKey: String, filter: String? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: Int64ApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return storageClearWithRequestBuilder(table: table, appKey: appKey, filter: filter).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     清空表数据
     - DELETE /Storage/{appKey}/{table}/Clear
     - 根据筛选条件清空指定表中的数据
     - Bearer Token:
       - type: http
       - name: Bearer
     ...
     */
    open class func storageClearWithRequestBuilder(table: String, appKey: String, filter: String? = nil) -> RequestBuilder<Int64ApiResponse> {
        var localVariablePath = "/Storage/{appKey}/{table}/Clear"
        let tablePreEscape = "\(APIHelper.mapValueToPathItem(table))"
        let tablePostEscape = tablePreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{table}", with: tablePostEscape, options: .literal, range: nil)
        let appKeyPreEscape = "\(APIHelper.mapValueToPathItem(appKey))"
    ...
    /**
     ...
     - parameter table: (path) 表名称 
     - parameter appKey: (path)  
     - parameter indexName: (query) 索引名称 (optional)
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    @discardableResult
    open class func storageDeleteIndex(table: String, appKey: String, indexName: String? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: BooleanApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return storageDeleteIndexWithRequestBuilder(table: table, appKey: appKey, indexName: indexName).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     删除索引
     - DELETE /Storage/{appKey}/{table}/indexes
     - 删除指定表的指定索引
     - Bearer Token:
       - type: http
       - name: Bearer
     ...
     - returns: RequestBuilder<BooleanApiResponse> 
     */
    open class func storageDeleteIndexWithRequestBuilder(table: String, appKey: String, indexName: String? = nil) -> RequestBuilder<BooleanApiResponse> {
        var localVariablePath = "/Storage/{appKey}/{table}/indexes"
        let tablePreEscape = "\(APIHelper.mapValueToPathItem(table))"
        let tablePostEscape = tablePreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{table}", with: tablePostEscape, options: .literal, range: nil)
        let appKeyPreEscape = "\(APIHelper.mapValueToPathItem(appKey))"
    ...
    /**
     ...
     - parameter nonce: (query) 随机字符串 
     - parameter timestamp: (query) 时间戳 
     - parameter signature: (query) 签名 
     - parameter appKey: (path)  
     - parameter executeFunctionRequest: (body) 函数请求参数 (optional)
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    @discardableResult
    open class func storageExecuteFunction(nonce: String, timestamp: Int64, signature: String, appKey: String, executeFunctionRequest: ExecuteFunctionRequest? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: ObjectApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return storageExecuteFunctionWithRequestBuilder(nonce: nonce, timestamp: timestamp, signature: signature, appKey: appKey, executeFunctionRequest: executeFunctionRequest).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     执行函数
     - GET /Storage/{appKey}/ExecuteFunction
     - 执行指定的函数
     - Bearer Token:
       - type: http
       - name: Bearer
     ...
     - returns: RequestBuilder<ObjectApiResponse> 
     */
    open class func storageExecuteFunctionWithRequestBuilder(nonce: String, timestamp: Int64, signature: String, appKey: String, executeFunctionRequest: ExecuteFunctionRequest? = nil) -> RequestBuilder<ObjectApiResponse> {
        var localVariablePath = "/Storage/{appKey}/ExecuteFunction"
        let appKeyPreEscape = "\(APIHelper.mapValueToPathItem(appKey))"
        let appKeyPostEscape = appKeyPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{appKey}", with: appKeyPostEscape, options: .literal, range: nil)
        let localVariableURLString = ZSGF.ClientAPI.basePath + localVariablePath
     ...
     */
    @discardableResult
    open class func storageExport(table: String, appKey: String, filter: String? = nil, startTime: Date? = nil, endTime: Date? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: URL?, _ error: Error?) -> Void)) -> RequestTask {
        return storageExportWithRequestBuilder(table: table, appKey: appKey, filter: filter, startTime: startTime, endTime: endTime).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     导出数据
     - GET /Storage/{appKey}/{table}/Export
     - 根据筛选条件导出指定表中的数据
     - Bearer Token:
       - type: http
       - name: Bearer
     ...
     */
    open class func storageExportWithRequestBuilder(table: String, appKey: String, filter: String? = nil, startTime: Date? = nil, endTime: Date? = nil) -> RequestBuilder<URL> {
        var localVariablePath = "/Storage/{appKey}/{table}/Export"
        let tablePreEscape = "\(APIHelper.mapValueToPathItem(table))"
        let tablePostEscape = tablePreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{table}", with: tablePostEscape, options: .literal, range: nil)
        let appKeyPreEscape = "\(APIHelper.mapValueToPathItem(appKey))"
     ...
     */
    @discardableResult
    open class func storageImport(table: String, appKey: String, file: URL? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: BooleanApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return storageImportWithRequestBuilder(table: table, appKey: appKey, file: file).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     导入数据
     - POST /Storage/{appKey}/{table}/Import
     - 从文件导入数据到指定表中
     - Bearer Token:
       - type: http
       - name: Bearer
     ...
     - returns: RequestBuilder<BooleanApiResponse> 
     */
    open class func storageImportWithRequestBuilder(table: String, appKey: String, file: URL? = nil) -> RequestBuilder<BooleanApiResponse> {
        var localVariablePath = "/Storage/{appKey}/{table}/Import"
        let tablePreEscape = "\(APIHelper.mapValueToPathItem(table))"
        let tablePostEscape = tablePreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{table}", with: tablePostEscape, options: .literal, range: nil)
        let appKeyPreEscape = "\(APIHelper.mapValueToPathItem(appKey))"
     ...
     */
    @discardableResult
    open class func storageIndexes(table: String, appKey: String, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: ObjectListApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return storageIndexesWithRequestBuilder(table: table, appKey: appKey).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     获取索引
     - GET /Storage/{appKey}/{table}/Indexes
     - 获取指定表的索引列表
     - Bearer Token:
       - type: http
       - name: Bearer
     ...
     - returns: RequestBuilder<ObjectListApiResponse> 
     */
    open class func storageIndexesWithRequestBuilder(table: String, appKey: String) -> RequestBuilder<ObjectListApiResponse> {
        var localVariablePath = "/Storage/{appKey}/{table}/Indexes"
        let tablePreEscape = "\(APIHelper.mapValueToPathItem(table))"
        let tablePostEscape = tablePreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{table}", with: tablePostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - parameter table: (path) 表名称（小写字母加数字,1-50位） 
     - parameter appKey: (path)  
     - parameter postIndexRequest: (body) json对象 / json数组 (optional)
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    @discardableResult
    open class func storagePostIndex(table: String, appKey: String, postIndexRequest: PostIndexRequest? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: StringApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return storagePostIndexWithRequestBuilder(table: table, appKey: appKey, postIndexRequest: postIndexRequest).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     添加索引
     - POST /Storage/{appKey}/{table}/indexes
     - 为指定表添加索引
     - Bearer Token:
       - type: http
       - name: Bearer
     ...
     - returns: RequestBuilder<StringApiResponse> 
     */
    open class func storagePostIndexWithRequestBuilder(table: String, appKey: String, postIndexRequest: PostIndexRequest? = nil) -> RequestBuilder<StringApiResponse> {
        var localVariablePath = "/Storage/{appKey}/{table}/indexes"
        let tablePreEscape = "\(APIHelper.mapValueToPathItem(table))"
        let tablePostEscape = tablePreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{table}", with: tablePostEscape, options: .literal, range: nil)
        ...
        localVariablePath = localVariablePath.replacingOccurrences(of: "{appKey}", with: appKeyPostEscape, options: .literal, range: nil)
        let localVariableURLString = ZSGF.ClientAPI.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: postIndexRequest)
     ...
     */
    @discardableResult
    open class func storageRemove(table: String, appKey: String, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: BooleanApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return storageRemoveWithRequestBuilder(table: table, appKey: appKey).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     删除表
     - DELETE /Storage/{appKey}/{table}/Remove
     - 删除指定表
     - Bearer Token:
       - type: http
       - name: Bearer
     ...
     - returns: RequestBuilder<BooleanApiResponse> 
     */
    open class func storageRemoveWithRequestBuilder(table: String, appKey: String) -> RequestBuilder<BooleanApiResponse> {
        var localVariablePath = "/Storage/{appKey}/{table}/Remove"
        let tablePreEscape = "\(APIHelper.mapValueToPathItem(table))"
        let tablePostEscape = tablePreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{table}", with: tablePostEscape, options: .literal, range: nil)
        let appKeyPreEscape = "\(APIHelper.mapValueToPathItem(appKey))"
     ...
     */
    @discardableResult
    open class func storageStats(table: String, appKey: String, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: ObjectApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return storageStatsWithRequestBuilder(table: table, appKey: appKey).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     数据表统计
     - GET /Storage/{appKey}/{table}/Stats
     - 获取指定表的数据统计信息
     - Bearer Token:
       - type: http
       - name: Bearer
     ...
     - returns: RequestBuilder<ObjectApiResponse> 
     */
    open class func storageStatsWithRequestBuilder(table: String, appKey: String) -> RequestBuilder<ObjectApiResponse> {
        var localVariablePath = "/Storage/{appKey}/{table}/Stats"
        let tablePreEscape = "\(APIHelper.mapValueToPathItem(table))"
        let tablePostEscape = tablePreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{table}", with: tablePostEscape, options: .literal, range: nil)
        let appKeyPreEscape = "\(APIHelper.mapValueToPathItem(appKey))"
     ...
     */
    @discardableResult
    open class func storageTables(appKey: String, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: StringListApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return storageTablesWithRequestBuilder(appKey: appKey).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     获取数据表
     - GET /Storage/{appKey}/Tables
     - 获取当前应用的所有数据表名称
     - Bearer Token:
       - type: http
       - name: Bearer
     - parameter appKey: (path)  
     - returns: RequestBuilder<StringListApiResponse> 
     */
    open class func storageTablesWithRequestBuilder(appKey: String) -> RequestBuilder<StringListApiResponse> {
        var localVariablePath = "/Storage/{appKey}/Tables"
        let appKeyPreEscape = "\(APIHelper.mapValueToPathItem(appKey))"
        let appKeyPostEscape = appKeyPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{appKey}", with: appKeyPostEscape, options: .literal, range: nil)
        let localVariableURLString = ZSGF.ClientAPI.basePath + localVariablePath
        ...
        let localVariableRequestBuilder: RequestBuilder<StringListApiResponse>.Type = ZSGF.ClientAPI.requestBuilderFactory.getBuilder()
