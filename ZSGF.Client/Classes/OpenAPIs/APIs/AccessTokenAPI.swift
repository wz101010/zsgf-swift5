...
open class AccessTokenAPI {
    ...
    open class func accessTokenDelete(id: Int64, appKey: String, userId: String? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: BooleanApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return accessTokenDeleteWithRequestBuilder(id: id, appKey: appKey, userId: userId).execute(apiResponseQueue) { result in
            switch result {
     ...
     */
    open class func accessTokenDeleteWithRequestBuilder(id: Int64, appKey: String, userId: String? = nil) -> RequestBuilder<BooleanApiResponse> {
    ...
    /**
     ...
     - parameter appKey: (path)  
     - parameter userId: (query)  (optional)
     - parameter accessTokenPostRequest: (body)  (optional)
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    @discardableResult
    open class func accessTokenPost(appKey: String, userId: String? = nil, accessTokenPostRequest: AccessTokenPostRequest? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: TokenModelApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return accessTokenPostWithRequestBuilder(appKey: appKey, userId: userId, accessTokenPostRequest: accessTokenPostRequest).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    open class func accessTokenPostWithRequestBuilder(appKey: String, userId: String? = nil, accessTokenPostRequest: AccessTokenPostRequest? = nil) -> RequestBuilder<TokenModelApiResponse> {
    ...
    /**
     ...
     - parameter appKey: (path)  
     - parameter userId: (query)  (optional)
     - parameter accessTokenPutRequest: (body)  (optional)
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    @discardableResult
    open class func accessTokenPut(id: Int64, appKey: String, userId: String? = nil, accessTokenPutRequest: AccessTokenPutRequest? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: BooleanApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return accessTokenPutWithRequestBuilder(id: id, appKey: appKey, userId: userId, accessTokenPutRequest: accessTokenPutRequest).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<BooleanApiResponse> 
     */
    open class func accessTokenPutWithRequestBuilder(id: Int64, appKey: String, userId: String? = nil, accessTokenPutRequest: AccessTokenPutRequest? = nil) -> RequestBuilder<BooleanApiResponse> {
        var localVariablePath = "/AccessToken/{appKey}/{id}"
        let idPreEscape = "\(APIHelper.mapValueToPathItem(id))"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
    ...
    open class func accessTokens(appKey: String, skip: Int? = nil, take: Int? = nil, userId: String? = nil, apiResponseQueue: DispatchQueue = ZSGF.ClientAPI.apiResponseQueue, completion: @escaping ((_ data: AccessTokenListResultApiResponse?, _ error: Error?) -> Void)) -> RequestTask {
        return accessTokensWithRequestBuilder(appKey: appKey, skip: skip, take: take, userId: userId).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    open class func accessTokensWithRequestBuilder(appKey: String, skip: Int? = nil, take: Int? = nil, userId: String? = nil) -> RequestBuilder<AccessTokenListResultApiResponse> {
        var localVariablePath = "/AccessToken/{appKey}"
        let appKeyPreEscape = "\(APIHelper.mapValueToPathItem(appKey))"
        let appKeyPostEscape = appKeyPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{appKey}", with: appKeyPostEscape, options: .literal, range: nil)
