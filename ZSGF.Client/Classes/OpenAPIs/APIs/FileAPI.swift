...
open class FileAPI {
    ...
    /**
     ...
     - parameter appKey: (path)  
     - parameter path: (query) 文件 / 文件夹路径 (optional)
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    @discardableResult
    ...
    /**
     ...
     - parameter appKey: (path)  
     - parameter sourceName: (query) 原文件 / 文件夹名称 (optional)
     - parameter destName: (query) 新文件 / 文件夹名称 (optional)
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    @discardableResult
     ...
     */
    open class func fileUploadWithRequestBuilder(appKey: String, path: String? = nil, file: URL? = nil) -> RequestBuilder<StringApiResponse> {
